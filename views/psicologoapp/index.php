    ...
    <div class="container">
        <div class="row p-5">
            <div class="col-sm-12">
                ...
                <p class="fs-4">Unete al discord para dar las citas <a href="https://discord.gg/y7AegjrWsy">aqui</a>  |  Mirar citas observadas <a href="<?php echo constant('URL')?>citasrealizadas">aqui</a></p>
            </div>
        </div>
        <div class="row">
            <div class="col-sm-12">
